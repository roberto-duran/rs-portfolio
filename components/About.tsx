...
const About = ({ pageInfo }: Props) => {
  return (
    <div
      className="flex flex-col relative justify-evenly mx-auto items-center
        ...
        <div>
          <div className="flex flex-col px-0 md:px-10 md:flex-row md:justify-between">
            ...
            <div className="hidden sm:block mt-5 md:mt-0 md:w-1/5 lg:w-1/3">
              ...
              <div
                className="flex flex-row md:flex-col justify-evenly border-b border-b-gray-400
              ...
              >
                <div className="py-5 border-b-transparent border-b-transparent md:border-b md:border-b-gray-400">
                  <span className="text-gray-300 font-bold">Phone:</span>{" "}
                  <span>{pageInfo?.phone_number}</span>
                </div>
                <div className="py-5">
                  <span className="text-gray-300 font-bold">From:</span>{" "}
          ...
          <div className="py-5">
            <button
              className="w-full bg-green-900 py-5 px-10 rounded-sm text-xl
